...
import { deleteBlock } from "@/app/dashboard/actions";
...
export function DeleteBlockButton({ blockId }: { blockId: string }) {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-lg border border-rose-200 bg-rose-50/80 p-2 sm:flex-row sm:items-center">
      <span className="text-xs font-medium text-rose-900">¿Eliminar este bloqueo?</span>
